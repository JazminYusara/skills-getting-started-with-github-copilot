...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and practice tennis skills with competitive tournaments",
    ...
    "Science Club": {
        "description": "Conduct experiments, learn about STEM, and explore scientific discoveries",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["rachel@mergington.edu", "ryan@mergington.edu"]
    }
}
